 ...
 *
 * This should allow to crop pages (e.g remove header, footer and between page empty
 * spaces) while extracting layout text preserving the pdf internal text formatting.
 *
