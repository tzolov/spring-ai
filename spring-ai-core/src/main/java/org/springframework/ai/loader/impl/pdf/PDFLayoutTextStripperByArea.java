...
/**
 * Re-implement the PDFLayoutTextStripperByArea on top of the PDFLayoutTextStripper instead the original
 * PDFTextStripper.
 *
 * This should allow to crop pages (e.g remove header, footer and between page empty spaces) while extracting layout
 * text preserving the pdf internal text formatting.
 *
...
public class PDFLayoutTextStripperByArea extends PDFLayoutTextStripper {
     ...
     * @param rect The rectangle area to retrieve the text from. The y-coordinates are java coordinates (y == 0 is top),
     * not PDF coordinates (y == 0 is bottom).
     */
