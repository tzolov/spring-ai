 ...
 */
public class TextChatHistoryTransformer extends AbstractSlidingWindowDatumTransformer<Message> {
	...
	public TextChatHistoryTransformer(TokenCountEstimator tokenCountEstimator, int maxTokenSize,
	...
	public PromptContext transform(PromptContext promptContext) {
		...
		String historyContext = purgedPromptContext.getMessageList().stream()
