...
* xref:api/clients/vertexai-chat.adoc[Google Vertex AI PaLM2 Chat Completion] (no streaming support)
* xref:api/clients/vertexai-gemini-chat.adoc[Google Vertex AI Gemini Chat Completion] (no streaming support)
