...
package org.springframework.ai.chat.memory.session.internal;
...
import org.springframework.ai.chat.memory.session.EventFilter;
import org.springframework.ai.chat.memory.session.Session;
import org.springframework.ai.chat.memory.session.SessionEvent;
import org.springframework.ai.chat.memory.session.SessionRepository;
import org.springframework.ai.chat.memory.session.SessionService;
import org.springframework.ai.chat.memory.session.compaction.CompactionRequest;
