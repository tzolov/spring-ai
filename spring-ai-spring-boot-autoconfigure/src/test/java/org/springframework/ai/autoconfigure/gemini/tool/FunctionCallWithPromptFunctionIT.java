...
package org.springframework.ai.autoconfigure.gemini.tool;
...
import org.springframework.ai.autoconfigure.gemini.VertexAiGeminiAutoConfiguration;
...
public class FunctionCallWithPromptFunctionIT {
	...
	void functionCallTest() {
		contextRunner.withPropertyValues("spring.ai.vertex.ai.gemini.chat.options.modelName=gemini-pro")
			.run(context -> {
